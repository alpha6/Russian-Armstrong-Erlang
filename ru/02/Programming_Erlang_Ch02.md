...
я рассказываю как я настроил Эрланг в Windows на совместную работу с MinGW и MSYS.
...
систем. Инструкции по их установке сильно зависят от конкретной
операционной системы. Так что мы пройдемся по ним обоим.
...
Но для пользователей Mac OS X и Linux возможны задержки между официальным
...
Эта ссылка будет содержать адрес исходного кода, который можно
...
без нее Эрланг не может определить, что мы закончили выражение и
...
*   Во-вторых, = - это вовсе не оператор присваивания.
